function VehicleList = PathPlanning(VehicleList,laneWidth,IntersectionBounds,TurnSpace, Vmax, TransmitLine)
KdSai = 10;
KpSai = 0.1;
                ...
                if i ~= j
                    ...
                    if Lane2 == Lane 
                        if dist < 20
                            % slow down
                            found = 1;
                            if VehicleList(i).v > 2
                                VehicleList(i).v = VehicleList(i).v - 1;
                            end
                        end    
                    end
                end 
