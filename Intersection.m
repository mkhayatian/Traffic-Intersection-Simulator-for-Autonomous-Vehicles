...
while (time < SimulationTime)
    ...
    if ~isempty(VehicleList)
        [Network, VehicleList] = SendToNetwork(VehicleList, Network, IntersectionBounds, TransmitLine,time);
    ...
    for iteration = 1 : ComputationSpeedFactor
        ...
        Vmax,Vmin,laneWidth,TransmitLine,time,CarLength,WCRTD);
